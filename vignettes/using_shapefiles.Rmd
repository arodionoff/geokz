...
# options(rstudio.python.installationPath = "D:/Python/Anaconda3")
# Sys.setenv(RETICULATE_MINICONDA_PATH = "D:/Python/Miniconda3")
# Sys.setenv(RETICULATE_MINICONDA_PATH = "D:/Python/Anaconda3")
# reticulate::install_miniconda(path = miniconda_path(), update = TRUE, force = FALSE)
# reticulate::conda_install(envname  = 'r-reticulate', packages = c('pandas', 'geopandas'))
reticulate::miniconda_path()
# reticulate::use_miniconda()
# reticulate::use_condaenv('D:\\Python\\Anaconda3\\envs\\r-reticulate', required = TRUE)
