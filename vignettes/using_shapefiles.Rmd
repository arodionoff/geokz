---
title: "Loading shape files using R & Python"
author: "Alexander Rodionov"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Loading shape files using R & Python}
...
Kazakhstan is divided into 14 regions (Kazakh: облыстар/oblystar; singular: облыс/oblys; Russian: области/oblasti; singular: область/oblast' ).
...
shpfile <- 
  system.file("shape", "kaz_admbnda_adm1_2018.shp", package = "geokz")

kaz_ADM1_sf <- 
  sf::st_read(dsn = shpfile)
...
kaz_ADM1_sf <- 
  kaz_ADM1_sf %>% 
    dplyr::mutate(Regions = dplyr::case_when(
      ...
      ADM1_PCODE == "KZ35"                                      ~ "Center",
      ADM1_PCODE == "KZ63"                                      ~ "East",
      TRUE                                                      ~ "South"      
    ) %>% 
...
# reticulate::conda_install(envname  = 'r-reticulate', packages = c('pandas', 'lightgbm'))
reticulate::miniconda_path()
reticulate::use_miniconda()
# reticulate::use_virtualenv('D:/Program Files/Python/venvs/ml_python_37', required = TRUE)
...
c:
cd C:/Users/arodionov/AppData/Local/r-miniconda/envs/r-reticulate
pip install pandas
...
```{python Load Libs & Data, engine.path="C:/Users/arodionov/AppData/Local/r-miniconda/envs/r-reticulate/python.exe"}
# ```{python}
