...
There is a three-level administrative division in Kazakhstan. Akimats of villages, rural and settlement districts, cities of district (Aktobe & Karaganda) and regional significance belong to units of administrative-territorial division of **the third level.** There were 2352 administrative-territorial units of the third level in 2022 year: 48 akimats of cities of district significance, 4 akimats of districts in cities of regional significance, 29 akimats of village districts, 2179 akimats of rural districts, 92 rural akimats.
...
dplyr::inner_join( x = get_kaz_oblasts_map(),
  ...
  tmap::qtm(
    ...
    title = "Population Density of Kazakhstan (2022)",
    format = "World"
    )
